  ...
  },
  {
    ...
    children: [
      { path: '', pathMatch: 'full', redirectTo: 'overview' },
      {
        ...
        title: 'Overview · Mochi',
      },
      {
        path: 'realtime',
        loadComponent: () => import('./pages/realtime').then((m) => m.Realtime),
        title: 'Realtime · Mochi',
      },
      {
        path: 'pages',
      ...
      },
      {
        ...
        title: 'Traffic sources · Mochi',
      },
      {
        path: 'geography',
        loadComponent: () => import('./pages/geography').then((m) => m.Geography),
        title: 'Geography · Mochi',
      },
      {
        path: 'devices',
      ...
      {
        path: 'websites',
        loadComponent: () => import('./pages/websites').then((m) => m.Websites),
        title: 'Websites · Mochi',
      },
      {
        path: 'add-website',
        loadComponent: () => import('./pages/add-website').then((m) => m.AddWebsite),
        title: 'Add website · Mochi',
      },
      {
        path: 'privacy',
        loadComponent: () => import('./pages/privacy').then((m) => m.Privacy),
        title: 'Privacy center · Mochi',
      },
      {
        path: 'settings',
        loadComponent: () => import('./pages/settings').then((m) => m.Settings),
        title: 'Website settings · Mochi',
      },
